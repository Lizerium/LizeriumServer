...
export class Documents {
    ...
    */
    async start(): Promise<void> {
        // Добавляем ссылку на "Оглавление" в текст
        const tocLink = document.querySelector('p a[href="#Оглавление"]') as unknown as HTMLLinkElement;
        if (tocLink) {
            tocLink.href = "#toc"; // Меняем ссылку на "Оглавление" 
        }
    }
}