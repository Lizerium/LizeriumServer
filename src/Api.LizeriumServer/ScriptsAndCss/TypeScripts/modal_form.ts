class ModalForm {
    ...
    constructor(headerText: string, typeFlex: string, dopClass: string = null) {
        ...
        this.modalForm = document.getElementById("modal_form") as HTMLDivElement;

        //получаем крестик закрытия модальной формы
        this.modalClose = this.modalForm.querySelector(".close_model") as HTMLDivElement;

        //получаем контейнер тела модальной формы
        this.modalBody = this.modalForm.querySelector(".modal_body") as HTMLDivElement;
        ...
        const headerModel = this.modalForm.querySelector(".modal_header") as HTMLDivElement;
        ...
        //подписываемся на клик по крестику закрытия модальной формы
    ...
    */
    ...
    async showConfirmForm(textConfirm: string, yesText: string, noText: string): Promise<boolean> {
        ...
        return new Promise<boolean>(resolve => {
            ...
            //добавляем обработку клика по кнопке Да
            btnYes.addEventListener("click", () => {

                //вызываем промис с true
                resolve(true);
