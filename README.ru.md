...
- SEO под несколько публичных доменов
...
- Динамические `robots.txt`, `sitemap.xml`, canonical и OpenGraph URL из конфигурации
- Защита от DoS-атак
